...
# ======================
# SIDEBAR MENU (OPSI B: MENGGUNAKAN RADIO)
# ======================
with st.sidebar:
...
# --- PERUBAHAN DISINI ---
# Menggunakan radio button agar menu "terpisah" dan langsung terlihat
...
# LOAD DATA
# ======================
# Pastikan file dataset ada di folder dataset
...
# ============================================================
    ...
    # Pastikan kolom Cluster ada di dataset
    ...
    # ======================
    recommendation_text = {
        0: "Reaktivasi agresif melalui promosi besar atau diskon signifikan, pengiriman pesan win-back seperti 'Kami kangen kamu', serta pemberian voucher.",
        1: "Retensi jangka panjang dengan program loyalitas premium, pelayanan eksklusif, dan reward khusus seperti cashback VIP atau poin ekstra.",
        2: "Menjaga engagement melalui pengiriman reminder berkala, promo ringan seperti diskon kecil atau gratis ongkir."
    }
    ...
    with right:
        ...
        if btn and recency is not None:
            ...
            recommendation_res = recommendation_text[cluster_pred]

            # ---- OUTPUT ----
            st.markdown("<div class='result-box'>", unsafe_allow_html=True)
            st.success(f"Cluster Prediksi: **{cluster_name_res}**")
            st.info(f"Rekomendasi: {recommendation_res}")
            st.markdown("</div>", unsafe_allow_html=True)
